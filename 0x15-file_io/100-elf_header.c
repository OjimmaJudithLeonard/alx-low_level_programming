...
/**
 * print_magic - Prints the magic numbers for ELF header.
 * @e_ident: A pointer to an arraythat contains the ELF magic numbers.
 *
...
/**
 * print_class - Prints the class for ELF header.
...
/**
 * main - Displays the information that's contained in the
